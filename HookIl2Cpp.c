...
void HookIl2Cpp(void *GameAssembly) {
    ...
    il2cpp_class_get_type = (IL2CPP_CLASS_GET_TYPE)(uintptr_t)GetProcAddress(GameAssembly, "il2cpp_class_get_type");
    printf("il2cpp_class_get_type: 0x%llx\n", (unsigned long long)il2cpp_class_get_type);
